...
public class DBEmpPerYearGraphAction extends ActionSupport {
    ...
    private CategoryDataset createDataset() {
        ...
        List<EmployeesCountVO> empCountList = empDao.getEmpCountListPerYear();

        // create the dataset...
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        for (EmployeesCountVO empCountVO : empCountList) {
            dataset.addValue(empCountVO.getCount(), new String("Employees Count Per Year"), empCountVO.getCategory());
        }
        return dataset;
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
        ...
        // create the chart...
        JFreeChart chart = ChartFactory.createBarChart("Number Of Employees By Year", // chart
                                                                                      // title
