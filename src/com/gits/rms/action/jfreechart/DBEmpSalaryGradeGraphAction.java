...
public class DBEmpSalaryGradeGraphAction extends ActionSupport {
    ...
    private CategoryDataset createDataset() {
        ...
        List<EmployeesCountVO> empCountList = empDao.getEmpCountSalaryGrade();

        // create the dataset...
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        for (EmployeesCountVO empCountVO : empCountList) {
            dataset.addValue(empCountVO.getCount(), new String("Employee Count"), empCountVO.getCategory());
        }
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
        ...
        // create the chart...
        JFreeChart chart = ChartFactory.createBarChart("No. Of Employees By Grade", // chart
                                                                                    // title
