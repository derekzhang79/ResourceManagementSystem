...
public class ReportsEmployeeBirthdayAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        try {
            empList = empService.getEmployeeBirthdayReports(report);
            ...
            JasperCompileManager.compileReportToFile(getText("ApplicationAbsolutePath")
                ...
                + "resources/reports/birthdayReports/Birthday.jrxml", getText("ApplicationAbsolutePath")
                + ServletActionContext.getServletContext().getContextPath()
                + getText("WebContent")
                + "resources/reports/birthdayReports/Birthday.jasper");
        } catch (Exception e) {
            e.printStackTrace();
            return ERROR;
        }
