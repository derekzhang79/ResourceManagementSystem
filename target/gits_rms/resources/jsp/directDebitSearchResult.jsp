...
<div id="submenu_directDebit_searchList_div_id">
	<div class="submenu_bg">
		<s:if test="#session.DIRECTDEBIT_ADD == true">
			<sj:a href="setUpDirectDebit.action" targets="submenu_directDebit_searchList_div_id" indicator="indicatorSubMenuDirectDebitSearchResId_div" cssClass="link"><s:text name="MTIAddDirectDebit" /></sj:a> |
		</s:if>
		<s:if test="#session.DIRECTDEBIT_VIEW == true">
			<sj:a href="getAllDirectDebit.action" targets="submenu_directDebit_searchList_div_id" indicator="indicatorSubMenuDirectDebitSearchResId_div" cssClass="link"><s:text name="MTIViewDirectDebit"/></sj:a> |
			<sj:a href="directDebitSearchForm.action" targets="submenu_directDebit_searchList_div_id" indicator="indicatorSubMenuDirectDebitSearchResId_div" cssClass="link"><s:text name="MTISearchDirectDebit"/></sj:a>
		</s:if>
	</div>
	<br/>
	<img id="indicatorSubMenuDirectDebitSearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <div id="display_tag_directDebitSearchList_div_id">
		  <display:table class="tableborder" id="directDebitListId" name="dirDebitList" pagesize="${NO_OF_RECORDS}" requestURI="directDebitSearchResult.action" sort="list" defaultsort="1" defaultorder="ascending"  export="true">
		    <%
		    	try{
		    ...
		    <display:column property="preAccount" title="${HDDpreAccount}" />
		    
		    <display:column title="${HPreferred}" class="viewedit" sortable="true" media="html">
				...
				<s:else>
					...
					<sj:a href="%{listMakePreferredDirectDebit}" title="Make this as Preferred Account" targets="submenu_directDebit_searchList_div_id" indicator="indicatorSubMenuDirectDebitSearchResId_div"><s:text name="Toggle"/></sj:a>
				</s:else>
		    ...
		    <s:if test="#session.DIRECTDEBIT_VIEW==true">
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_directDebit_searchList_div_id','%{listViewDirectDebit}','');"><s:text name="View"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.DIRECTDEBIT_UPDATE==true">
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_directDebit_searchList_div_id','%{listSetUpDirectDebit}','');"><s:text name="Edit"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.DIRECTDEBIT_DELETE==true">
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_directDebit_searchList_div_id','%{listDeleteDirectDebit}','');"><s:text name="Delete"/></s:a>
				</display:column>
			</s:if>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_directDebitSearchList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script> 