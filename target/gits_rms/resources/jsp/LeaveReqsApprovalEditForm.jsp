...
<div id="submenu_LeaveRequest_Edit_Both_div">
...
<s:form action="updateLeaveReqsApproval">
	...
	<table align="center">
		<tr>
			<td>
				<img id="indicatorLeaveReqsApprovalEditFormImg" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
				<sj:submit targets="submenu_LeaveRequest_Edit_Both_div" indicator="indicatorLeaveReqsApprovalEditFormImg" cssClass="submitbutton117" clearForm="false"></sj:submit>
				
   			</td>
   		    <td>
   		    	<s:url var="resetLeaveRequest" action="resetLeaveRequest"></s:url>
   	            <sj:submit href="%{resetLeaveRequest}"  key="button.label.reset" cssClass="submitbutton117" targets="submenu_LeaveRequest_Edit_Both_div" indicator="indicatorLeaveReqsApprovalEditFormImg"/>
   	            
   	             <s:url var="backLeaveEmpEditListButton" action="backLeaveEmpEditListButton" escapeAmp="false">
	   		 ...
	   		 <sj:submit href="%{backLeaveEmpEditListButton}"  key="Back" cssClass="submitbutton117" targets="submenu_LeaveRequest_Edit_Both_div" indicator="indicatorLeaveReqsApprovalEditFormImg"/>
			</td>
		</tr>
