...
<div id="submenu_subCategory_searchList_div_id">
<div class="submenu_bg">
	<s:if test="#session.PERFORMANCESUBCATEGORY_ADD == true">
		<sj:a href="setUpSubCategory.action" targets="submenu_subCategory_searchList_div_id" indicator="indicatorSubMenuSubCategorySearchResId_div" cssClass="link"><s:text name="MTIAddSubCategory" /></sj:a> |
	</s:if>
	<s:if test="#session.PERFORMANCESUBCATEGORY_VIEW == true">
		<sj:a href="getAllSubCategory.action" targets="submenu_subCategory_searchList_div_id" indicator="indicatorSubMenuSubCategorySearchResId_div" cssClass="link"><s:text name="MTIViewSubCategory"/></sj:a> |
		<sj:a href="subCategorySearchForm.action" targets="submenu_subCategory_searchList_div_id" indicator="indicatorSubMenuSubCategorySearchResId_div" cssClass="link"><s:text name="MTISearchSubCategory"/></sj:a>	
	</s:if>
</div>
<br/>
<img id="indicatorSubMenuSubCategorySearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
	...
	<div class="informationMessageSingle"><li><span><s:text name="label.title.subCategory.list"/></span></li></div>
	  ...
	  <div id="display_tag_subcategorySearchList_div_id">
		  <display:table class="tableborder" id="subCategoryListId" name="subCategoryList" pagesize="${NO_OF_RECORDS}" requestURI="getAllSubCategory.action" sort="list" defaultsort="1" defaultorder="ascending" export="true">
		    ...
		    <s:if test="#session.COUNTRY_VIEW==true">
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_subCategory_searchList_div_id','%{listViewSubCategory}','');"><s:text name="View"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.COUNTRY_UPDATE==true">
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_subCategory_searchList_div_id','%{listSetUpSubCategory}','');"><s:text name="Edit"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.COUNTRY_DELETE==true">
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_subCategory_searchList_div_id','%{listDeleteSubCategory}','');"><s:text name="Delete"/></s:a>
				</display:column>
			</s:if>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_subcategorySearchList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>   