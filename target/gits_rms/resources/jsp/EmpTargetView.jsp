...
<div id="submenu_Emp_TargetViewId_div">
<div class="submenu_bg">
	<sj:a href="setUpEmpAddTargetGoal.action" targets="submenu_Emp_TargetViewId_div" indicator="indicatorSubMenuEmpTargetViewId_div" cssClass="link"><s:text name="MTIAddMyTaregtGoal" /></sj:a> |
	<sj:a href="getAllEmpTarget.action" targets="submenu_Emp_TargetViewId_div" indicator="indicatorSubMenuEmpTargetViewId_div" cssClass="link"><s:text name="MTIViewMyTaregtGoal"/></sj:a>
</div>
<br/>
<img id="indicatorSubMenuEmpTargetViewId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
