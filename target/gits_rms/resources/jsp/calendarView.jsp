...
<div id="timesheetCalendarView_div">
<s:if test="viewTimesheet=='View'">
	<div align="right">
		<s:url var="back" action="projectAssignedViewForm" namespace="/" escapeAmp="false"></s:url>
			<img id="indicatorTimesheetCalenderViewId" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
		<sj:a href="%{back}" cssClass="link" indicator="indicatorTimesheetCalenderViewId" targets="timesheetCalendarView_div">Back</sj:a>
	</div>
</s:if>
...
<td class="formtitle" colspan="6"> Timesheet Calendar</td>
  ...
  <tr>
    <td><table align="center" width="95%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      	<td width="30px">
		      	<s:url var="url1" value="getEmployeeDataCalendarYearDec.action" namespace="/" escapeAmp="false">
		        <s:param name="monthList" value="%{#request.prevMonth}"></s:param>
		        <s:param name="yearList" value="%{#request.prevYear}"></s:param>
		        </s:url>
	    	<sj:a href="%{#url1}" targets="timesheetCalendarView_div"><div class="previous" align="center"></div></sj:a>
        </td>
        <td style="color:#4E96DE"><div align="center"><h3>Year</h3></div></td>
        
        <td width="30px">
	        <s:url var="url1" value="getEmployeeDataCalendarYearInc.action" namespace="/" escapeAmp="false">
	        <s:param name="monthList" value="%{#request.prevMonth}"></s:param>
	        <s:param name="yearList" value="%{#request.prevYear}"></s:param>
	        </s:url>
	    	<sj:a href="%{#url1}" targets="timesheetCalendarView_div"><div class="next" align="center"></div></sj:a>
        </td>
        <td style="color:#4E96DE"><div align="center"><h3><%=new SimpleDateFormat("MMMM").format(new Date(iYear,iMonth,01))%> <%=iYear%></h3></div></td>
        <td width="7%">
	        <s:url var="url1" value="getEmployeeDataCalendarDec.action" namespace="/" escapeAmp="false">
	        <s:param name="monthList" value="%{#request.prevMonth}"></s:param>
	        <s:param name="yearList" value="%{#request.prevYear}"></s:param>
	        </s:url>
	    	<sj:a href="%{#url1}" targets="timesheetCalendarView_div"><div class="previous" align="center"></div></sj:a>
        ...
        <td width="8%">
	        <s:url var="url1" value="getEmployeeDataCalendarInc.action" namespace="/" escapeAmp="false">
	        <s:param name="monthList" value="%{#request.prevMonth}"></s:param>
	        <s:param name="yearList" value="%{#request.prevYear}"></s:param>
	        </s:url>
	    	<sj:a href="%{#url1}" targets="timesheetCalendarView_div"><div class="next" align="center"></div></sj:a>
        ...
        <tr>
          ...
          %>
             ...
             <td align="center" height="80" width="80" id="day_<%=(cnt-weekStartDay+1)%>" class="today">
                ...
                <sj:a href="%{dateClick}" targets="timesheetCalendarView_div"><%=cnt-weekStartDay+1%></sj:a>
             </td>
          <%
                }else{
                	request.setAttribute("dateDisplay",(cnt-weekStartDay+1));
           %>
                 ...
                 <s:else>
                     	<td align="center" height="80" width="80" id="day_<%=(cnt-weekStartDay+1)%>"><span>
                     		...
                     		<sj:a href="%{dateClick}" targets="timesheetCalendarView_div"><%=cnt-weekStartDay+1%></sj:a></span></td>
                 </s:else>
                 <s:set name="status" value="false"></s:set>
               <% 
                }
