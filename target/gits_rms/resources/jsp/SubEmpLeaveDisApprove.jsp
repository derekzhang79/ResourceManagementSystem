...
<div id="submenu_LeaveApproveDisApprove_Result_div">
...
<img id="indicatorSubMenuCountrySubEmpLeaveApprId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
	  ...
	  <table align="center"> 
    	 <tr>
   		    <td>
    		    <img id="indicatorLeaveDisApp" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
				<s:url var="backDisApproverTabButton" action="backDisApproverTabButton"></s:url>
	   			 <sj:submit href="%{backDisApproverTabButton}"  key="Back" cssClass="submitbutton117" targets="submenu_LeaveApproveDisApprove_Result_div" indicator="indicatorLeaveDisApp"/>
   		    </td>
   		</tr>
   	  </table>
</div>