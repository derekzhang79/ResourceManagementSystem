...
<div id="submenu_Currency_list_div_id">
<div class="submenu_bg">
	<s:if test="#session.CURRENCY_ADD == true">
		...
		<s:elseif test="#session.CHECK_CURRENCY == 'NOT_AVAILABLE'">
			<sj:a href="setUpCurrency.action" targets="submenu_Currency_list_div_id" indicator="indicatorSubMenuCurrency" cssClass="link"><s:text name="MTIAddCurrency"/></sj:a> |
		</s:elseif>
	</s:if>
	<s:if test="#session.CURRENCY_VIEW == true">
		<sj:a href="getAllCurrency.action" targets="submenu_Currency_list_div_id" indicator="indicatorSubMenuCurrency" cssClass="link"><s:text name="MTIViewCurrency"/></sj:a> 
	</s:if>
</div>
<br/>
<img id="indicatorSubMenuCurrency" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <div id="display_tag_currencyList_div_id">
		    ...
		    <display:column property="currencyType" title="${HCurrencyType}" sortable="true" headerClass="sortable"/>
		    	<s:if test="#session.CURRENCY_VIEW==true">
					<display:column title="${HView}" class="viewedit" media="html">
						...
						<s:a href="#" onclick="doPostCall('submenu_Currency_list_div_id','%{listViewCurrency}','');"><s:text name="View"/></s:a>
					</display:column>
				</s:if>
				<s:if test="#session.CURRENCY_UPDATE==true">
					<display:column title="${HEdit}" class="viewedit" media="html">
						...
						<s:a href="#" onclick="doPostCall('submenu_Currency_list_div_id','%{listSetUpCurrency}','');"><s:text name="Edit"/></s:a>
					</display:column>
				</s:if>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_currencyList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>  