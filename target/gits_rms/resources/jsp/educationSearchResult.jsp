...
<div id="submenu_education_searchList_div_id">
<div class="submenu_bg">
	<s:if test="#session.EDUCATION_ADD == true">
		<sj:a href="setUpEducation.action" targets="submenu_education_searchList_div_id" indicator="indicatorSubMenuEducationSearchResId_div" cssClass="link"><s:text name="MTIAddEducation" /></sj:a> |
	</s:if>
	<s:if test="#session.EDUCATION_VIEW == true">
		<sj:a href="getAllEducation.action" targets="submenu_education_searchList_div_id" indicator="indicatorSubMenuEducationSearchResId_div" cssClass="link"><s:text name="MTIViewEducation"/></sj:a> |
		<sj:a href="educationSearchForm.action" targets="submenu_education_searchList_div_id" indicator="indicatorSubMenuEducationSearchResId_div" cssClass="link"><s:text name="MTISearchEducation"/></sj:a>
	</s:if>
</div>
<br/>
<img id="indicatorSubMenuEducationSearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <div id="display_tag_educationSearchList_div_id">
		  <display:table class="tableborder" id="educationListId" name="eduList" pagesize="${NO_OF_RECORDS}" requestURI="educationSearchResult.action" sort="list" defaultsort="1" defaultorder="ascending"  export="true">
		    <%
		    	try{
		    ...
		    <s:if test="#session.EDUCATION_VIEW==true">
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_education_searchList_div_id','%{listViewEducation}','');"><s:text name="View"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.EDUCATION_UPDATE==true">
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_education_searchList_div_id','%{listSetUpEducation}','');"><s:text name="Edit"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.EDUCATION_DELETE==true">
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_education_searchList_div_id','%{listDeleteEducation}','');"><s:text name="Delete"/></s:a>
				</display:column>
			</s:if>
  ...
  <script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_educationSearchList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script> 