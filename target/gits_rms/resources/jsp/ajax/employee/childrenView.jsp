...
<div id="submenu_ESSChildrenView_div">
	...
	<s:url var="remoteChiView" value="/getEmployeeAllChildren.action">
	 ...
	 <s:if test="#session.CHILDREN_ADD==true">
		 <sj:a href="%{remoteChiForm}" indicator="indicatorChiList" targets="submenu_ESSChildrenView_div" cssClass="link"><s:text name="label.header.children.add"/></sj:a> |
	</s:if>
		<s:if test="#session.CHILDREN_ADD==true">
			<sj:a href="%{remoteChiView}" indicator="indicatorChiList" targets="submenu_ESSChildrenView_div" cssClass="link"><s:text name="label.header.children.view"/></sj:a>
		</s:if>
	</div>
	<br />
