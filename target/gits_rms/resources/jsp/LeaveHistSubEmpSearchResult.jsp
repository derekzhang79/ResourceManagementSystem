...
<div id="submenu_LeaveHistory_AppSearchResult_div">
<div class="informationMessageSingle"><li><span><s:text name="label.title.lhist.reportList"/></span></li></div>
<br />
<img id="indicatorSubMenuCountryLeaveHistSubEmpSearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
	  ...
	  <table align="center"> 
    	 <tr>
   		    <td>
    		    <img id="indicatorLeaveAppHist" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
				<s:url var="backLeaveAppHistoryTabButton" action="backLeaveAppHistoryTabButton"></s:url>
	   			 <sj:submit href="%{backLeaveAppHistoryTabButton}"  key="Back" cssClass="submitbutton117" targets="submenu_LeaveHistory_AppSearchResult_div" indicator="indicatorLeaveAppHist"/>
   		    </td>
   		</tr>
   	  </table>   
</div>