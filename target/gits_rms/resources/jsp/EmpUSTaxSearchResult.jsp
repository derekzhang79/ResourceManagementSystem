...
<div id="submenu_EmployeeUSTaxSearchResId_div">
<div class="submenu_bg">
	<s:if test="#session.EMPLOYEEUSTAX_ADD == true">
		<sj:a href="setUpEmpUSTax.action" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div" cssClass="link"><s:text name="MTIAddEmployeeUSTax" /></sj:a> |
	</s:if>
	<s:if test="#session.EMPLOYEEUSTAX_VIEW == true">
		<sj:a href="getAllEmpUSTax.action" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div" cssClass="link"><s:text name="MTIViewEmployeeUSTax"/></sj:a> |
		<sj:a href="usTaxSearchForm.action" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div" cssClass="link"><s:text name="MTISearchEmployeeUSTax"/></sj:a>
	</s:if>
</div>
<br/>
	<img id="indicatorSubMenuEmployeeUSTaxSearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <display:table class="tableborder" id="empUSTaxListId" name="empUSTaxList" pagesize="${NO_OF_RECORDS}" requestURI="usTaxSearchResult.action" sort="list" defaultsort="1" defaultorder="ascending"  export="true">
	    <%
	    	try{
	    ...
	    <s:if test="#session.EMPLOYEEUSTAX_VIEW==true">
			<display:column title="${HView}" class="viewedit" media="html">
				...
				<sj:a href="%{listViewEmployeeUSTax}" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div"><s:text name="View"/></sj:a>
			</display:column>
		</s:if>
	    <s:if test="#session.EMPLOYEEUSTAX_UPDATE==true">
			<display:column title="${HEdit}" class="viewedit" media="html">
				...
				<sj:a href="%{listSetUpEmployeeUSTax}" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div"><s:text name="Edit"/></sj:a>
			</display:column>
		</s:if>
	    <s:if test="#session.EMPLOYEEUSTAX_DELETE==true">
			<display:column title="${HDelete}" class="viewedit" media="html">
				...
				<sj:a href="%{listDeleteEmployeeUSTax}" targets="submenu_EmployeeUSTaxSearchResId_div" indicator="indicatorSubMenuEmployeeUSTaxSearchResId_div"><s:text name="Delete"/></sj:a>
			</display:column>
		</s:if>
