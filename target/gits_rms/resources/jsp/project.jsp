...
<div id="submenu_project_list_div_id">
<div class="submenu_bg">
	<s:if test="#session.PROJECT_ADD == true">
		<sj:a href="setUpProject.action" targets="submenu_project_list_div_id" indicator="indicatorSubMenuProjectId_div" cssClass="link"><s:text name="MTIAddProject" /></sj:a> |
	</s:if>
	<s:if test="#session.PROJECT_VIEW == true">
		<sj:a href="getAllProjects.action" targets="submenu_project_list_div_id" indicator="indicatorSubMenuProjectId_div" cssClass="link"><s:text name="MTIViewProject"/></sj:a> |
		<sj:a href="projectsSearchForm.action" targets="submenu_project_list_div_id" indicator="indicatorSubMenuProjectId_div" cssClass="link"><s:text name="MTISearchProject"/></sj:a>
	</s:if>
</div>
<br/>
<img id="indicatorSubMenuProjectId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <s:text name="label.header.project.estimatedHours" var="HProjectEstimatedHours"></s:text>
	  <s:text name="label.header.common.description" var="HProjectDescription"></s:text>
	  <s:text name="label.common.link.view" var="HView"></s:text>
	  <s:text name="label.common.link.edit" var="HEdit"></s:text>
	  <s:text name="label.common.link.delete" var="HDelete"></s:text>
	  		   
	  <div id="display_tag_projectList_div_id">
		  <display:table class="tableborder" id="projectListId" name="proList" pagesize="${NO_OF_RECORDS}" requestURI="getAllProjects.action" sort="list" defaultsort="1" defaultorder="ascending" export="true">
		    <%
		    	try{
		    ...
		    <display:column property="estimatedHours" title="${HProjectEstimatedHours}" sortable="true" headerClass="sortable"/>
		    ...
		    <s:if test="#session.PROJECT_VIEW==true">
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_project_list_div_id','%{listViewProject}','');"><s:text name="View"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.PROJECT_UPDATE==true">
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_project_list_div_id','%{listSetUpProject}','');"><s:text name="Edit"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.PROJECT_DELETE==true">
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_project_list_div_id','%{listDeleteProject}','');"><s:text name="Delete"/></s:a>
				</display:column>
			</s:if>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_projectList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>    
