...
<div id="submenu_OrganizationSearchId_div">
<div class="submenu_bg">
	<s:if test="#session.ORGANIZATION_ADD == true">
		<sj:a href="setUpOrganization.action" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div" cssClass="link"><s:text name="MTIAddOrganization" /></sj:a> |
	</s:if>
	<s:if test="#session.ORGANIZATION_VIEW == true">
		<sj:a href="getAllOrganization.action" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div" cssClass="link"><s:text name="MTIViewOrganization"/></sj:a> |
		<sj:a href="organizationSearchForm.action" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div" cssClass="link"><s:text name="MTISearchOrganization"/></sj:a>
	</s:if>
</div>
<br/>
<img id="indicatorSubMenuOrganizationSearchId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <display:table class="tableborder" id="orgListId" name="orgList" pagesize="${NO_OF_RECORDS}" requestURI="organizationSearchResult.action" sort="list" defaultsort="1" defaultorder="ascending" export="true">
	    <%
	    	try{
	    ...
	    <display:column property="description" title="${HOrganizationDescrition}" sortable="true" headerClass="sortable"/>
	    ...
	    <s:if test="#session.ORGANIZATION_VIEW==true">
			<display:column title="${HView}" class="viewedit" media="html">
				...
				<sj:a href="%{listViewOrganization}" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div"><s:text name="View"/></sj:a>
			</display:column>
		</s:if>
	    <s:if test="#session.ORGANIZATION_UPDATE==true">
			<display:column title="${HEdit}" class="viewedit" media="html">
				...
				<sj:a href="%{listSetUpOrganization}" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div"><s:text name="Edit"/></sj:a>
			</display:column>
		</s:if>
	    <s:if test="#session.ORGANIZATION_DELETE==true">
			<display:column title="${HDelete}" class="viewedit" media="html">
				...
				<sj:a href="%{listDeleteOrganization}" targets="submenu_OrganizationSearchId_div" indicator="indicatorSubMenuOrganizationSearchId_div"><s:text name="Delete"/></sj:a>
			</display:column>
		</s:if>
