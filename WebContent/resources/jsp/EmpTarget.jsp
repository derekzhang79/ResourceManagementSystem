...
<div id="submenu_Emp_TargetId_div">
<div class="submenu_bg">
	<sj:a href="setUpEmpAddTargetGoal.action" targets="submenu_Emp_TargetId_div" indicator="indicatorSubMenuEmpTargetId_div" cssClass="link"><s:text name="MTIAddMyTaregtGoal" /></sj:a> |
	<sj:a href="getAllEmpTarget.action" targets="submenu_Emp_TargetId_div" indicator="indicatorSubMenuEmpTargetId_div" cssClass="link"><s:text name="MTIViewMyTaregtGoal"/></sj:a>
</div>
<br/>
<img id="indicatorSubMenuEmpTargetId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
...
<jsp:include page="common/messages.jsp" flush="true"/>
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <display:table class="tableborder" id="empTargetGoalListId" name="empTargetGoalList" pagesize="${NO_OF_RECORDS}" requestURI="getAllEmpTarget.action" sort="list" defaultsort="1" defaultorder="ascending"  export="true">
	    <%
	    	try{
	    ...
	    <display:column property="empTargetAchieved" title="${HTargetAchieved}" sortable="true" headerClass="sortable"/>
			<display:column title="${HView}" class="viewedit" media="html">
				<s:url var="listViewEmpTargetGoal" action="viewEmpTarget">
					<s:param name="empTAGObj.hcmoEmpTgId" value="#request.EmpTGId"></s:param>
				</s:url>
				<sj:a href="%{listViewEmpTargetGoal}" targets="submenu_Emp_TargetId_div" indicator="indicatorSubMenuEmpTargetId_div"><s:text name="View"/></sj:a>
			</display:column>
