...
<div id="submenu_projectActivity_div_id">
<div class="submenu_bg">
	<s:if test="#session.PROJECTACTIVITY_ADD == true">
		<sj:a href="setUpProjectActivity.action" targets="submenu_projectActivity_div_id" indicator="indicatorSubMenuProjectActivityId_div" cssClass="link"><s:text name="MTIAddProjectActivity" /></sj:a> |
	</s:if>
	<s:if test="#session.PROJECTACTIVITY_VIEW == true">
		<sj:a href="getAllProjectActivity.action" targets="submenu_projectActivity_div_id" indicator="indicatorSubMenuProjectActivityId_div" cssClass="link"><s:text name="MTIViewProjectActivity"/></sj:a> |
		<sj:a href="projectActivitySearcForm.action" targets="submenu_projectActivity_div_id" indicator="indicatorSubMenuProjectActivityId_div" cssClass="link"><s:text name="MTISearchProjectActivity"/></sj:a>
	</s:if>
		
</div>
<br/>
<img id="indicatorSubMenuProjectActivityId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <s:text name="label.header.project.estimatedHours" var="HProActivityEstHours"></s:text>
	  <s:text name="label.form.fields.common.notes" var="HProjectActivityNotes"></s:text>
	  <s:text name="label.common.link.view" var="HView"></s:text>
	  <s:text name="label.common.link.edit" var="HEdit"></s:text>
	  <s:text name="label.common.link.delete" var="HDelete"></s:text>
	  		   
	  <div id="display_tag_projectActivityList_div_id">
		  <display:table class="tableborder" id="projectActivityListId" name="projActivityList" pagesize="${NO_OF_RECORDS}" requestURI="getAllProjectActivity.action" sort="list" defaultsort="1" defaultorder="ascending" export="true">
		    <%
		    	try{
		    ...
		    <display:column property="estimatedHours" title="${HProActivityEstHours}" sortable="true" headerClass="sortable"/>
		    ...
		    <s:if test="#session.PROJECTACTIVITY_VIEW==true">
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_projectActivity_div_id','%{listViewProjectActivity}','');"><s:text name="View"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.PROJECTACTIVITY_UPDATE==true">
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_projectActivity_div_id','%{listSetUpProjectActivity}','');"><s:text name="Edit"/></s:a>
				</display:column>
			</s:if>
		    <s:if test="#session.PROJECTACTIVITY_DELETE==true">
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_projectActivity_div_id','%{listDeleteProjectActivity}','');"><s:text name="Delete"/></s:a>
				</display:column>
			</s:if>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_projectActivityList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>    