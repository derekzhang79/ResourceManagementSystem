...
<div id="submenu_NumberingQuestionsView_div">
	<div class="submenu_bg">
		<sj:a href="setUpNumberingQuestions.action" targets="submenu_NumberingQuestion_div" indicator="indicatorNumberingQuestionsView" cssClass="link"><s:text name="MTIAddQuestion" /></sj:a> |
		<sj:a href="getAllNumberingQuestions.action" targets="submenu_NumberingQuestion_div" indicator="indicatorNumberingQuestionsView" cssClass="link"><s:text name="MTIViewQuestion"/></sj:a>
	</div>
<br/>
<img id="indicatorNumberingQuestionsView" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
		...
		<table class="maintable">
	      <tr>
			...
			<tr>
				...
				<td class="employeedisplaytd"><s:property value="question.minRate"/></td>
			</tr>
			<tr>
				<td class="inputtext"><s:text name="label.header.question.maxRate" /></td>
				<td class="employeedisplaytd"><s:property value="question.maxRate"/></td>
			</tr>
			<tr>
