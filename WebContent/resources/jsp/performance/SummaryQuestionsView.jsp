...
<div id="submenu_SummaryQuestionsView_div">
	<div class="submenu_bg">
		<sj:a href="setUpSummaryQuestions.action" targets="submenu_SummaryQuestionsView_div" indicator="indicatorSummaryQuestionsView" cssClass="link"><s:text name="MTIAddQuestion" /></sj:a> |
		<sj:a href="getAllSummaryQuestions.action" targets="submenu_SummaryQuestionsView_div" indicator="indicatorSummaryQuestionsView" cssClass="link"><s:text name="MTIViewQuestion"/></sj:a>
	</div><br/>
	<img id="indicatorSummaryQuestionsView" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>
