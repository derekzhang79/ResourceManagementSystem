...
<%@ taglib prefix="sj" uri="/struts-jquery-tags"%>
	...
	<sj:div id="essEmployeeInformationDivId">
		<s:form>
		         ...
		         <tr>
		         	<td class="forminner"><table class="tablealign">
						...
						<tr>
							...
							<td class="employeedisplaytd"><s:property value="employee.empDriLicenNum"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="employeedisplaytd"><s:property value="employee.empCityName" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="employeedisplaytd"><s:date name="employee.updated" format="%{getText('label.date.simpleDateFormatWithTime')}" /></td>
						</tr>
					 	<tr>
						...
						<tr>
							...
							<td class="employeedisplaytd"><s:checkbox name="employee.isActive" label="isActive" disabled="true"></s:checkbox></td>
						</tr>
