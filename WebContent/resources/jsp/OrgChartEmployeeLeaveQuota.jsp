...
<div id="submenu_orgChartleaveQuota_list_div_id">
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>		   
	   	...
	   	<div id="display_tag_orgChartEmployeeLeaveQuotaList_div_id">
		   	<display:table class="tableborder" id="employeeLeaveQuotaListId" name="empLeaveList" pagesize="${NO_OF_RECORDS}" requestURI="orgChartEmployeeLeaveQuotaNewTab.action" sort="list" defaultsort="1" defaultorder="ascending"  export="true">
		    <%
		    	try{
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_orgChartEmployeeLeaveQuotaList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>              		