...
<div id="submenu_vendor_searchList_div_id">
<div class="submenu_bg">
	<sj:a href="setUpForInsertOrUpdateVendor.action" targets="submenu_vendor_searchList_div_id" indicator="indicatorSubMenuVendorSearchResId_div" cssClass="link"><s:text name="MTIAddVendor" /></sj:a> |
	<sj:a href="getAllVendor.action" targets="submenu_vendor_searchList_div_id" indicator="indicatorSubMenuVendorSearchResId_div" cssClass="link"><s:text name="MTIViewVendor"/></sj:a> |
	<sj:a href="vendorSearchForm.action" targets="submenu_vendor_searchList_div_id" indicator="indicatorSubMenuVendorSearchResId_div" cssClass="link"><s:text name="MTISearchVendor"/></sj:a>
</div>
<br/>
<img id="indicatorSubMenuVendorSearchResId_div" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <div id="display_tag_vendorSearchList_div_id">
		  <display:table class="tableborder" id="vendorListId" name="vendorList" pagesize="${NO_OF_RECORDS}" requestURI="vendorSearchResult.action" sort="list" defaultsort="1" defaultorder="ascending" export="true">
		    <%
		    	try{
		    ...
		    <display:column property="emailAddress1" title="${HEmailAddress1}" sortable="true" headerClass="sortable"/>
				...
				<display:column title="${HView}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_vendor_searchList_div_id','%{listViewVendor}','');"><s:text name="View"/></s:a>
				</display:column>
				...
				<display:column title="${HEdit}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_vendor_searchList_div_id','%{listSetUpVendor}','');"><s:text name="Edit"/></s:a>
				</display:column>
				...
				<display:column title="${HDelete}" class="viewedit" media="html">
					...
					<s:a href="#" onclick="doPostCall('submenu_vendor_searchList_div_id','%{listDeleteVendor}','');"><s:text name="Delete"/></s:a>
				</display:column>
...
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_vendorSearchList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>     