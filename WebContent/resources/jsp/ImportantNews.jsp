...
<div id="submenu_importantNews_list_div_id">
<div class="submenu_bg">
		<sj:a href="setUpImportantNews.action" targets="submenu_importantNews_list_div_id" indicator="indicatorSubMenuImportantNews" cssClass="link"><s:text name="MTIAddImportantNews" /></sj:a> |
		<sj:a href="getAllImportantNews.action" targets="submenu_importantNews_list_div_id" indicator="indicatorSubMenuImportantNews" cssClass="link"><s:text name="MTIViewImportantNews"/></sj:a> |
		<sj:a href="importantNewsSearchForm.action" targets="submenu_importantNews_list_div_id" indicator="indicatorSubMenuImportantNews" cssClass="link"><s:text name="MTISearchImportantNews"/></sj:a>
</div>
<br/>
<img id="indicatorSubMenuImportantNews" src="${pageContext.request.contextPath}/resources/images/indicator.gif" alt="Loading..." style="display:none"/>				    
	...
	<s:set name="NO_OF_RECORDS" value="#session.NO_OF_RECORDS"></s:set>
	  ...
	  <div id="display_tag_importantNewsList_div_id">
		  <display:table class="tableborder" id="importantNewsId" name="impList" pagesize="${NO_OF_RECORDS}" requestURI="getAllImportantNews.action" sort="list" defaultsort="1" defaultorder="ascending">
		    <%
		    	try{
		    ...
		    <display:column title="${HShowMessage}" style="text-align:center">
	                <s:checkbox id="check" name="#request.ImpNewsShowMessageId" disabled="true"/>
	       	        ...
	       	        <display:column title="${HMakeChangesToShowMessage}">
						...
						<sj:a href="%{listMakeChangesToShowMessage}" title="Make Change To Show Message" targets="submenu_importantNews_list_div_id" indicator="indicatorSubMenuImportantNews"><s:text name="Show Message"/></sj:a>
						</s:else>
					</display:column>   
					...
					<s:a href="#" onclick="doPostCall('submenu_importantNews_list_div_id','%{listViewImportantNews}','');"><s:text name="View"/></s:a>
					</display:column>
					<display:column title="${HEdit}" class="viewedit" media="html">
						<s:url var="listSetUpImportantNews" action="setUpImportantNews">
							<s:param name="important.importantNewsId" value="#request.ImportantNeswId"></s:param>
						</s:url>
					<s:a href="#" onclick="doPostCall('submenu_importantNews_list_div_id','%{listSetUpImportantNews}','');"><s:text name="Edit"/></s:a>
					</display:column>
					...
					<s:a href="#" onclick="doPostCall('submenu_importantNews_list_div_id','%{listDeleteImportantNews}','');"><s:text name="Delete"/></s:a>
					</display:column>
		  </display:table>   
	  </div>
</div> 
<script type="text/javascript">
	//To submit the Sorting and Pagination of DisplayTag in a Div
   	jQuery(document).ready(function() {
   		try{
   		 	jQuery("#display_tag_importantNewsList_div_id").displayTagAjax();
   		}catch(e){
   		}
  	});
</script>    
